...
# -------------------------------------------------------
OWNER_USERNAME = getenv("OWNER_USERNAME","legendmickey")
# --------------------------------------------------------
BOT_USERNAME = getenv("BOT_USERNAME","Zenitsu_music_xbot")
# --------------------------------------------------------
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/terimakich/Purvi-Music",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "main")
GIT_TOKEN = getenv(
    "GIT_TOKEN", "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") 

API_URL = getenv("API_URL", 'https://api.thequickearn.xyz') #youtube song url
API_KEY = getenv("API_KEY", '3CVXA3PUAZUHXP24IXHUOT3QKFAFJ3RX'') # youtube song api ke
